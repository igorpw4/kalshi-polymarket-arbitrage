...
Lembra que 79% dos deltas eram negativos — o `priceToBeat` da Chainlink tipicamente **abaixo** do strike da Kalshi? Isso não é ruído estatístico, é estrutural. E tem uma consequência que eu demorei a enxergar: **o sinal do delta determina qual tipo de divergência pode acontecer.**
